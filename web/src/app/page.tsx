  ...
  return (
    <main className='grid grid-cols-2 min-h-screen'>
      <div className='flex flex-col items-start justify-between px-28 py-16 relative overflow-hidden border-r border-white/10 bg-[url(../assets/bg-stars.svg)]'>
        ...
        <a href='#' className='flex items-center gap-3 px-5 py-4 rounded-lg text-left hover:bg-gray-400/20 transition-colors'>
        ...
        <div className='text-sm leading-relaxed text-gray-200'>
          Feito com 💜 no NLW da RocketseatFeito com 💜 no NLW da  {' '}
          <a
            href='#'
